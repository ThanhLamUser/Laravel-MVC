    ...
    <div class="adm__all-movies col l-9 m-4 c-6">
        ...
        <div class="adm__all-movies--container">
            <table>
                ...
                @foreach ($list_popcorndrink as $key => $popcorndrink_pro)
                <tr>
                    <th>{{ $popcorndrink_pro->popcorndrink_combo }}</ỵ>
                    <th>{{ $popcorndrink_pro->popcorndrink_popcorn}}</ỵ>
                    <th>{{ $popcorndrink_pro->popcorndrink_drink}}<th>
                        <button onclick="confirmDelete('{{ URL::to('/delete-popcorndrink/'.$popcorndrink_pro->popcorndrink_id) }}')" id="adm__all-movies--del--btn">DELETE</button>
                    </th>
                </tr>
            @endforeach
            </table>
