...
@section('content')
    <div class="content">
        <div class="grid wide">
            <div class="search-result col l-12 m-12 c-12">
                            ...
                            <div class="col l-12 m-4 c-6" style="width:223px" onclick="transfer('movie/{{ $movie_pro->movie_id }}')">
                                <div class="now-showing--movies-single">
                                    ...
                                    <div class="now-showing--movies-single-tags">
                                        <span
                                            class="now-showing--movies-single-tag--1">{{ $movie_pro->movie_age }}</span>
                                        <span class="now-showing--movies-single-tag--2">Subtitles</span>
                                        <span
                                            class="now-showing--movies-single-tag--1">{{ $movie_pro->movie_time }}'</span>
                                    </div>
                                    <div class="now-showing--movies-single-name">{{ $movie_pro->movie_name }}
                                    </div>
                                    <div class="now-showing--movies-single-cat">{{ $movie_pro->movie_category }}
                                    </div>
                                    ...
                                    <div class="now-showing--movies-single-buttons">
                                        <button class="now-showing--movies-single-buy-tickets">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                                                class="now-showing--movies-single-buy-tickets--img">
                                                <path
                                        ...
                                        <button class="now-showing--movies-single-info"
                                            class="now-showing--movies-single-buy-tickets--img">
